                ...
                if query:
                    ...
                    if 'error' not in results:
                        ...
                        for count, item in enumerate(results['data'][offset:]):
                            ...
                            if botId == '5749083150' and 'magnet' in item:
                                ...
                                markup = telebot.types.InlineKeyboardMarkup()
                                markup.add(telebot.types.InlineKeyboardButton(text=language['joinChannelBtn'][userLanguage], url='https://t.me/robo_helpers'), telebot.types.InlineKeyboardButton(text=language['joinDiscussionBtn'][userLanguage], url='https://t.me/Robo_helper'))
